...
USERS = [
    ...
    dict(email="chitra.ps@harvestinternationalschool.in", name="Ms Chitra P S",  designation="HOD",  role="auditor", location="Both"),
...
TEACHERS = [
  ...
  ('nishat.f@harvestinternationalschool.in', 'Nishat Fatima', 'Kodathi', 'debtanaya@harvestinternationalschool.in'),
