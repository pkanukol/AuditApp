...
USERS = [
    # --- Auditors ---
    dict(email="pavani.k@harvestinternationalschool.in", name="Auditor Pavani", designation="Academic Auditor", role="auditor", location="Both"),
    dict(email="principal.kodathi@harvestinternationalschool.in", name="Ms Lakshmi Nayar", designation="Principal", role="auditor", location="Both"),
    dict(email="principal.attibele@harvestinternationalschool.in", name="Ms Divya Barat", designation="Principal", role="auditor", location="Both"),
    dict(email="tharunnya@harvestinternationalschool.in", name="Ms Tharunnya M A",   designation="Vice Principal",  role="auditor", location="Both"),
    dict(email="chitra@harvestinternationalschool.in",  name="Ms Chitra Venkatesh Prasanna", designation="Curriculum Head", role="auditor", location="Both"),
    dict(email="ramanpreet@harvestinternationalschool.in",  name="Ms Ramanpreet Kaur", designation="HOD",  role="auditor", location="Both"),
    dict(email="chvinny@harvestinternationalschool.in", name="Ms Vinny Arora",  designation="Curriculum Head",  role="auditor", location="Both"),
    dict(email="sumathi@harvestinternationalschool.in", name="Ms Sumathi M S",  designation="Coordinator",  role="auditor", location="Kodathi"),
    dict(email="khushboo@harvestinternationalschool.in", name="Ms Khushboo Jain",  designation="Coordinator",  role="auditor", location="Kodathi"),
    # --- HODs ---
    dict(email="love@harvestinternationalschool.in", name="Mr Love Agrawal",  designation="HOD",  role="sme", location="Both"),
    dict(email="jiji.francis@harvestinternationalschool.in",  name="Ms Jiji Francis", designation="HOD", role="sme", location="Both"),
    dict(email="Timsy.Thomas@harvestinternationalschool.in", name="Ms Timsy Thomas",  designation="HOD",  role="sme", location="Both"),
    dict(email="chitra.ps@harvestinternationalschool.in", name="Ms Chitra P S",  designation="HOD",  role="sme", location="Both"),
    dict(email="sujata.m@harvestinternationalschool.in",  name="Ms Sujata Sengupta", designation="HOD", role="sme", location="Both"),
    dict(email="Shailaja@harvestinternationalschool.in",  name="Ms Nanjappa Shailaja", designation="HOD", role="sme", location="Both"),
    dict(email="bani@harvestinternationalschool.in",  name="Ms Bani Saha", designation="HOD", role="sme", location="Both"),
    # --- SMEs ---
    dict(email="deepak.d@harvestinternationalschool.in", name="Mr Deepak Damodaran", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="debtanaya@harvestinternationalschool.in", name="Ms Debtanaya Banerjee", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="levina@harvestinternationalschool.in",  name="Ms Levina M", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="bhuvana@harvestinternationalschool.in", name="Ms Bhuvana R", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="nagaraj@harvestinternationalschool.in", name="Mr Nagaraj Mudenur", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="manju.bala@harvestinternationalschool.in",  name="Ms Manju Bala", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="francisjoy@harvestinternationalschool.in", name="Mr Francis Joy", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="madhuri.j@harvestinternatinalschool.in", name="Ms Madhuri Jha ", designation="Subject Matter Expert", role="sme", location="Both"),
    dict(email="sutesh@harvestinternationalschool.in",  name="Ms Sutesh Yadav", designation="Subject Matter Expert", role="sme", location="Both"),
    ]
...
TEACHERS = [
  ...
  ('mary.p@harvestinternationalschool.in', 'Ms Mary Priyanka', 'Kodathi', 'jiji.francis@harvestinternationalschool.in'),
  ('mary.p@harvestinternationalschool.in', 'Ms Mary Priyanka', 'Kodathi', 'sutesh@harvestinternationalschool.in'),
  ('mary.p@harvestinternationalschool.in', 'Ms Mary Priyanka', 'Kodathi', 'love@harvestinternationalschool.in'),
